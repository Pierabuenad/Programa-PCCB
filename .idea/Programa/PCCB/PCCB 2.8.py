...
class AsignacionSecciones(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        as_st = wx.StaticText(self.panel, label="ASIGNAR SECCIONES", pos=(100, 10))
        ...
        for q in range(self.filas):
            ...
            if self.datos_dg[2] == 1:
                if self.datos_dg[3] == 1:
                    if q == 0:
                        wx.StaticText(self.panel, label='V. Izquiedo', pos=(15, self.l+5))
                        self.l += 50
                    elif q+1 == self.filas:
        ...
        # Funciones de los botones rehacerla
...
app = wx.App()
frame = MainWindow(None, "PCCB Version 2.8 2015")
app.MainLoop()