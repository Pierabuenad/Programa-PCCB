...
class DatosSecciones(wx.Frame):
    def __init__(self, parent):
        ...
        self.numsecsv = wx.TextCtrl(self.panel, value="", pos=(200, 40), size=(80, -1), validator=CharValidator("no-alpha"))
    ...
    def OnOk(self, event):
        ...
        for i in range(int(self.nssv)):
            ...
            self.area = wx.TextCtrl(self.panel, value='', pos=(j + 75, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.a.append(self.area)

            self.inercia = wx.TextCtrl(self.panel, value='', pos=(j + 175, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.ine.append(self.inercia)

            self.v1 = wx.TextCtrl(self.panel, value='', pos=(j + 275, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.vsup.append(self.v1)

            self.v2 = wx.TextCtrl(self.panel, value='', pos=(j + 375, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.vinf.append(self.v2)

            self.ancho = wx.TextCtrl(self.panel, value='', pos=(j + 475, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.b.append(self.ancho)

            self.almas = wx.TextCtrl(self.panel, value='', pos=(j + 575, l), size=(80, -1), validator=CharValidator("no-alpha"))
...
class EstructurasParciales(wx.Frame):
    def __init__(self, parent):
        ...
        self.numestpar = wx.TextCtrl(self.panel, value="", pos=(200, 40), size=(80, -1), validator=CharValidator("no-alpha"))
    ...
    def OnOk(self, event):
        ...
        for i in range(int(self.nep)):
            ...
            n = wx.TextCtrl(self.panel, value='', pos=(j + 75, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.name.append(n)

            sr = wx.TextCtrl(self.panel, value='', pos=(j + 175, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.sec.append(sr)

            secin = wx.TextCtrl(self.panel, value='', pos=(j + 275, l), size=(80, -1), validator=CharValidator("no-alpha"))
            self.si.append(secin)

            secfin = wx.TextCtrl(self.panel, value='', pos=(j + 375, l), size=(80, -1), validator=CharValidator("no-alpha"))
