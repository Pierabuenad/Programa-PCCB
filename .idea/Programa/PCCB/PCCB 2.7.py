...
class EstructurasParciales(wx.Frame):
    def __init__(self, parent):
        ...
        wx.StaticText(self.panel, label='Seccion resistente: ', pos=(420, 45))
        a = wx.RadioButton(self.panel, -1, "Solo viga", style=wx.RB_GROUP, pos=(550, 45))
        b = wx.RadioButton(self.panel, -1, "Viga + Losa", pos=(650, 45))
